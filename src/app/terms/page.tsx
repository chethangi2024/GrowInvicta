      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 text-xs sm:text-sm text-[var(--text-secondary)] leading-relaxed font-sans">
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--text-primary)] tracking-tight">1. Service Agreements &amp; Scope</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--text-primary)] tracking-tight">2. Sprint Milestones &amp; Delivery Targets</h2>
            <p className="text-[var(--text-secondary)]">Grow Invicta operates on structured milestones:</p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--text-primary)] tracking-tight">3. Payment Structure</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--text-primary)] tracking-tight">4. 100% Intellectual Property &amp; Asset Transfer</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--text-primary)] tracking-tight">5. Limitation of Liability &amp; Jurisdiction</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
