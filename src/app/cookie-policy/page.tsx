      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10 text-xs sm:text-sm text-[var(--text-secondary)] leading-relaxed font-sans">
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--text-primary)] tracking-tight">1. What Are Cookies?</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--text-primary)] tracking-tight">2. Cookie Categories</h2>
            <ul className="list-disc pl-5 space-y-2 text-[var(--text-secondary)] font-mono text-xs">
              <li>
                <strong className="text-[var(--text-primary)]">Essential &amp; Technical Cookies:</strong> Necessary for core website navigation, responsive canvas frame caching, and secure session operation.
              </li>
              <li>
                <strong className="text-[var(--text-primary)]">Performance &amp; Analytics Cookies:</strong> Measure aggregated visitor counts and navigation pathways to optimize Core Web Vitals and load performance.
              </li>
              <li>
                <strong className="text-[var(--text-primary)]">Third-Party Integration Cookies:</strong> Generated when interacting with our embedded Cal.com scheduling interface.
              </li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[var(--text-primary)] tracking-tight">3. User Controls</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
